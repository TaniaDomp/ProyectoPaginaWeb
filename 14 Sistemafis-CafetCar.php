    ...
    if (isset($_SESSION['carrito1'])){
        if (isset($_GET['id'])){
            ...
            if ($encontro == true){
                ...
                header("location: 14 Sistemafis-CafetCar.php");
            }
            else{
                $nombre="";
                $precio="";
...
<body>
    ...
    <?php 
    $total = 0;
    if ($_SESSION['carrito1']){
        $arregloCar = $_SESSION['carrito1'];
   ...
   <?php 
    ...
    <div class="colum-dere">
        <button class="btn-re" onclick="window.location = '14 SistemafisCompra-caf.php'">Realizar compra</button>
    </div>
    </div>
