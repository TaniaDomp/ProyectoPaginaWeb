...
<body>
    ...
    <div class="menu-sis">
        ...
        <div class="car">
            <a href="15%20SistemaVonline-liboCar.php"><i class="fas fa-shopping-cart">  Ir a carrito</i></a>
        </div>
        <div class="cer-se">
    ...
    <a href="15%20SistemaVonline-liboCar.php?id=<?php echo $fila[0]; ?>" class="btn-bot">Añadir a carrito</a>
