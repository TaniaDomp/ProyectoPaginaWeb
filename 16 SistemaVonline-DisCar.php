    ...
    if (isset($_SESSION['carrito7'])){
        if (isset($_GET['id'])){
            ...
            if ($encontro == true){
                ...
                $_SESSION['carrito7']=$arreglo;
                header("location: 16 SistemaVonline-DisCar.php");
            }
            else{
                $nombre="";
                $precio="";
...
<body>
    ...
    <?php 
    $total = 0;
    if ($_SESSION['carrito7']){
        $arregloCar = $_SESSION['carrito7'];
   ...
   <?php 
    ...
    <div class="colum-dere">
        <button class="btn-re" onclick="window.location = '16 SistemaVonlineCompra-dis.php'">Realizar compra</button>
    </div>
    </div>
