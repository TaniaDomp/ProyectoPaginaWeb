<?php
    ...
    if (isset($_SESSION['carrito9'])){
        if (isset($_GET['id'])){
             $arreglo = $_SESSION['carrito9'];
             $encontro = false;
            $numero = 0;
            ...
            if ($encontro == true){
                ...
                $_SESSION['carrito9']=$arreglo;
                header("location: 17 Sistemafis-BolCar.php");
            }
            else{
                $nombre="";
                $precio="";
...
<body>
    ...
    <div class="menu-sis">
        <div class="img-lo">
            <a href="17%20Sistemafis-Bol.php"><img src="Logo-supsi.jpg" alt="" class="product__img1"></a>
        </div>
        <div class="cer-se">
    ...
    <?php 
    $total = 0;
    if ($_SESSION['carrito9']){
        $arregloCar = $_SESSION['carrito9'];
   ...
   <?php 
    ...
    <div class="colum-dere">
        <button class="btn-re" onclick="window.location = '17 SistemafisCompra-bol.php'">Realizar compra</button>
    </div>
    </div>
