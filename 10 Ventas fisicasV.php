...
<body>
    ...
    <h1>Elija el área de venta</h1><br>
    ...
    <div class="Colum">
        <div class="container">
            ...
            <div class="colum-tex">
                <h2>Librería</h2>
                <p>Venta de libros</p>
                <a href="15-1%20Sistemafis-Lib.php" class="btn-bot2">Vamos ahora</a>
            </div>
        </div>
    </div>
    <div class="Colum">
        <div class="container">
            ...
            <div class="colum-tex">
                <h2>Librería</h2>
                <p>Venta de discos</p>
                <a href="16-1%20Sistemafis-dis.php" class="btn-bot2">Vamos ahora</a>
            </div>
        </div>
    </div>
    <div class="Colum">
        <div class="container">
            ...
            <div class="colum-tex">
                ...
                <a href="17-1%20Sistemafis-Bol.php" class="btn-bot2">Vamos ahora</a>
            </div>
        </div>
    </div>
    <div class="Colum">
        <div class="container">
            ...
            <div class="colum-tex">
                <h2>Cafetería</h2>
                <p>Venta de comida</p>
                <a href="14-1%20Sistemafis-Cafet.php" class="btn-bot2">Vamos ahora</a>
            </div>
        </div>
    </div>
