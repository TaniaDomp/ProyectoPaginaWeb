...
$compra = "SELECT * FROM ventasfis_lib";
?>
...
<body>
    ...
    <div class="container-tab">
        ...
        ?>
        <div class="table-item"><?php echo $row["id_vlib"];?></div>
        <div class="table-item">$<?php echo number_format($row["total_lib"], 2, '.', '');?></div>
        <div class="table-item"><?php echo $row["fecha_lib"];?></div>
