...
$compra = "SELECT * FROM producto_lib";
?>
...
<body>
    ...
    <div class="container-tab">
        ...
        ?>
        <div class="table-item"><?php echo $row["id_prodlib"];?></div>
        <div class="table-item"><?php echo $row["nombre_plib"];?></div>
        <div class="table-item">$<?php echo number_format($row["precio_plib"], 2, '.', '');?></div>
        <div class="table-item"><?php echo $row["inventario_plib"];?></div>
        <div class="table-item"><?php echo $row["descripcion_plib"];?></div>
        <div class="table-item"><img src="<?php echo $row['imagen_plib']; ?>" alt="<?php echo $row['nombre_plib']; ?>" class="imagen_car"></div>
