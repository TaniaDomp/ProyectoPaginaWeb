<?php
    ...
    if (!isset($_SESSION['carrito6'])){
        header('location: 16 Sistemafis-dis.php');
    }
    
    $arreglo = $_SESSION['carrito6'];
...
<body>
    ...
    <div class="menu-sis">
        <div class="img-lo">
            <a href="16%20Sistemafis-dis.php"><img src="Logo-supsi.jpg" alt="" class="product__img1"></a>
        </div>
        <div class="cer-se">
   ...
   <div class= "dos-colum2"> 
    ...
    <center><button class="btn-re" onclick="window.location = '16 Sistemafis-dis.php'">Regresar a la tienda</button></center>
