...
$compra = "SELECT * FROM ventasfis_dis";
?>
...
<body>
    ...
    <div class="container-tab">
        ...
        ?>
        <div class="table-item"><?php echo $row["id_vdis"];?></div>
        <div class="table-item">$<?php echo number_format($row["total_dis"], 2, '.', '');?></div>
        <div class="table-item"><?php echo $row["fecha_dis"];?></div>
