...
<title>Recursos humanos y ventas</title>
</head>
<body>
    ...
    <h2>Área de Recursos humanos y ventas</h2><br>
    ...
    <div class="container-flex3">
        <div class="colum-3 colum33">
            ...
            <center><a href="10%20Ventas%20fisicasV.php" class="btn-bot2">Ir a la sección</a></center>
            </div>
        </div>
        <div class="colum-3 colum33">
            ...
            <p class="product__price">Revise los pedidos recientes</p>
