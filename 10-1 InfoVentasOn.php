...
<title>Info ventas online</title>
</head>
<body>
    ...
    <h1>Elija el área que desea revisar</h1><br>
    ...
    <div class="Colum">
        <div class="container">
            ...
            <div class="colum-tex">
                <h2>Librería</h2>
                <p>Venta de libros</p>
                <a href="21%20infovent-libo.php" class="btn-bot2">Vamos ahora</a>
            </div>
        </div>
    </div>
    <div class="Colum">
        <div class="container">
            ...
            <div class="colum-tex">
                <h2>Librería</h2>
                <p>Venta de discos</p>
                <a href="21%20infovent-diso.php" class="btn-bot2">Vamos ahora</a>
            </div>
        </div>
    </div>
    <div class="Colum">
        <div class="container">
            ...
            <div class="colum-tex">
                ...
                <a href="21%20infovent-bolo.php" class="btn-bot2">Vamos ahora</a>
            </div>
        </div>
    </div>
    <div class="Colum">
        <div class="container">
            ...
            <div class="colum-tex">
                <h2>Cafetería</h2>
                <p>Venta de comida</p>
                <a href="21%20infovent-cafo.php" class="btn-bot2">Vamos ahora</a>
            </div>
        </div>
    </div>
