...
<body>
    ...
    <div class="menu-sis">
        ...
        <div class="car">
            <a href="16-1%20Sistemafis-DisCar.php"><i class="fas fa-shopping-cart">   Ir a la venta</i></a>
        </div>
        <div class="cer-se">
    ...
    ?>
        ...
        <div class="product">
            <a href = "16-1%20Sistemafis-DisCar.php?id=<?php echo $fila['id_produdis']; ?>"><img src="<?php echo $fila['imagen_pdis']; ?>" alt="<?php echo $fila['nombre_pdis']; ?>" class="product__img"></a>
            <div class="product__description">
            <h3 class="product__title"><?php echo $fila['nombre_pdis']; ?></h3>
            <p class="product__price">$<?php echo $fila['precio_pdis']; ?></p>
            <center><a href="16-1%20Sistemafis-DisCar.php?id=<?php echo $fila['id_produdis']; ?>" class="btn-bot2">Añadir</a></center>
            </div>
        </div>
        </div>
    <?php 
