    ...
    if (isset($_SESSION['carrito3'])){
        if (isset($_GET['id'])){
            ...
            if ($encontro == true){
                ...
                header("location: 15 Sistemafis-LibCar.php");
            }
            else{
                $nombre="";
                $precio="";
...
<body>
    ...
    <?php 
    $total = 0;
    if ($_SESSION['carrito3']){
        $arregloCar = $_SESSION['carrito3'];
   ...
   <?php 
    ...
    <div class="colum-dere">
        <button class="btn-re" onclick="window.location = '15 SistemafisCompra-lib.php'">Realizar compra</button>
    </div>
    </div>
