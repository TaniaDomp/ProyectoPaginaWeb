...
<body>
    ...
    ?>
        ...
        <div class="product">
            <a href = "15%20SistemaVonline-libo1.php?id=<?php echo $fila['id_prodlib']; ?>"><img src="<?php echo $fila['imagen_plib']; ?>" alt="<?php echo $fila['nombre_plib']; ?>" class="product__img"></a>
            <div class="product__description">
            <h3 class="product__title"><?php echo $fila['nombre_plib']; ?></h3>
            <p class="product__price">$<?php echo $fila['precio_plib']; ?></p>
            <center><a href="15%20SistemaVonline-libo1.php?id=<?php echo $fila['id_prodlib']; ?>" class="btn-bot2">Comprar</a></center>
            </div>
        </div>
        </div>
    <?php 
