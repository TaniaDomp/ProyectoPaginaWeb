<?php
    ...
    if (!isset($_SESSION['carrito7'])){
        header('location: 15 SistemaVonline-Dis.php');
    }
...
<body>
    ...
    <center><button class="btn-re" onclick="window.location = '16 SistemaVonlineCompra-disF.php'"> Realizar compra</button></center>
