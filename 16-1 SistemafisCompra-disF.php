<?php
    ...
    if (!isset($_SESSION['carrito8'])){
        header('location: 16-1 Sistemafis-dis.php');
    }
    
    $arreglo = $_SESSION['carrito8'];
    ...
    $conexion -> query ("INSERT INTO ventasfis_dis(total_dis, fecha_dis, Usuario) VALUES ($total, '$fecha', '$usuario1')") or die ($conexion->error); 
    
    $id_vcafo = $conexion -> insert_id;

    for ($i=0;$i<count($arreglo);$i++){
        $conexion -> query ("INSERT INTO ventaspr_fisdis(id_vdis, id_produdis, cantidad, precio_pdis, subtotal_dis) VALUES 
        ($id_vcafo, 
        ".$arreglo[$i]['Id'].",
        ".$arreglo[$i]['Cantidad'].",
        ".$arreglo[$i]['Precio'].",
...
<body>
    ...
    <div class="menu-sis">
        <div class="img-lo">
            <a href="16-1%20Sistemafis-dis.php"><img src="Logo-supsi.jpg" alt="" class="product__img1"></a>
        </div>
        <div class="cer-se">
   ...
   <div class= "dos-colum2"> 
    ...
    <center><button class="btn-re" onclick="window.location = '16-1 Sistemafis-dis.php'">Regresar a la tienda</button></center>
