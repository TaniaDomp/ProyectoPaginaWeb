<?php
    ...
    if (!isset($_SESSION['carrito2'])){
        header('location: 14-1 Sistemafis-Cafet.php');
    }
...
<body>
    ...
    <br><br><center><button class="btn-re" onclick="window.location = '14-1 SistemafisCompra-cafF.php'"> Realizar compra</button></center>
