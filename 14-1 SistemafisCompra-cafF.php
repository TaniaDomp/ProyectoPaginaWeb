<?php
    ...
    $conexion -> query ("INSERT INTO ventasfis_caf(total_caf, fecha_caf, Usuario) VALUES ($total, '$fecha', '$usuario1')") or die ($conexion->error); 
    
    $id_vcafo = $conexion -> insert_id;

    for ($i=0;$i<count($arreglo);$i++){
        $conexion -> query ("INSERT INTO ventaspr_fiscaf(id_vcaf, id_producaf, cantidad, precio_caf, subtotal_caf) VALUES 
        ($id_vcafo, 
        ".$arreglo[$i]['Id'].",
        ".$arreglo[$i]['Cantidad'].",
        ".$arreglo[$i]['Precio'].",
...
<body>
    ...
    <div class="menu-sis">
        <div class="img-lo">
            <a href="14-1%20Sistemafis-Cafet.php"><img src="Logo-supsi.jpg" alt="" class="product__img1"></a>
        </div>
        <div class="cer-se">
   ...
   <div class= "dos-colum2"> 
    ...
    <center><button class="btn-re" onclick="window.location = '14-1 Sistemafis-Cafet.php'">Regresar a la tienda</button></center>
