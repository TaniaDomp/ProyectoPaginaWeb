<?php
    ...
    if (!isset($_SESSION['carrito3'])){
        header('location: 15 Sistemafis-Lib.php');
    }
...
<body>
    ...
    <div class="menu-sis">
        <div class="img-lo">
            <a href="15%20Sistemafis-Lib.php"><img src="Logo-supsi.jpg" alt="" class="product__img1"></a>
        </div>
        <div class="cer-se">
   ...
   <div class= "dos-colum2"> 
    ...
    <center><button class="btn-re" onclick="window.location = '15 Sistemafis-Lib.php'">Regresar a la tienda</button></center>
