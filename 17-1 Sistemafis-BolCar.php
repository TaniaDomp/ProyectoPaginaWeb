    ...
    if (isset($_SESSION['carrito11'])){
        if (isset($_GET['id'])){
            ...
            if ($encontro == true){
                ...
                $_SESSION['carrito11']=$arreglo;
                header("location: 17-1 Sistemafis-BolCar.php");
            }
            else{
                $nombre="";
                $precio="";
...
<body>
    ...
    <?php 
    $total = 0;
    if ($_SESSION['carrito11']){
        $arregloCar = $_SESSION['carrito11'];
   ...
   <?php 
    ...
    <div class="colum-dere">
        <button class="btn-re" onclick="window.location = '17-1 SistemafisCompra-bol.php'">Realizar compra</button>
    </div>
    </div>
