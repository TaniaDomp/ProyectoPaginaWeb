    ...
    if (isset($_SESSION['carrito'])){
        if (isset($_GET['id'])){
            ...
            if ($encontro == true){
                ...
                header("location: 14 SistemaVonline-CafetCar.php");
            }
            else{
                $nombre="";
                $precio="";
...
<body>
   ...
   <?php 
    ...
    <div class="colum-dere">
        <button class="btn-re" onclick="window.location = '14 SistemaVonlineCompra-cafo.php'">Realizar compra</button>
    </div>
    </div>
