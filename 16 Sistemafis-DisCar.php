    ...
    if (isset($_SESSION['carrito6'])){
        if (isset($_GET['id'])){
            ...
            if ($encontro == true){
                ...
                $_SESSION['carrito6']=$arreglo;
                header("location: 16 Sistemafis-DisCar.php");
            }
            else{
                $nombre="";
                $precio="";
...
<body>
    ...
    <?php 
    $total = 0;
    if ($_SESSION['carrito6']){
        $arregloCar = $_SESSION['carrito6'];
   ...
   <?php 
    ...
    <div class="colum-dere">
        <button class="btn-re" onclick="window.location = '16 SistemafisCompra-dis.php'">Realizar compra</button>
    </div>
    </div>
