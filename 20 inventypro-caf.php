...
$compra = "SELECT * FROM producto_cafo";
?>
...
<body>
    ...
    <div class="container-tab">
        ...
        ?>
        <div class="table-item"><?php echo $row["id_producafo"];?></div>
        <div class="table-item"><?php echo $row["nombre_pcafo"];?></div>
        <div class="table-item">$<?php echo number_format($row["precio_pcafo"], 2, '.', '');?></div>
        <div class="table-item"><?php echo $row["inventario_pcafo"];?></div>
        <div class="table-item"><?php echo $row["Descripcion-pcafo"];?></div>
        <div class="table-item"><img src="<?php echo $row['imagen_pcafo']; ?>" alt="<?php echo $row['nombre_pcafo']; ?>" class="imagen_car"></div>
