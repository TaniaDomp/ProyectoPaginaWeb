    ...
    if (isset($_SESSION['carrito4'])){
        if (isset($_GET['id'])){
            ...
            if ($encontro == true){
                ...
                $_SESSION['carrito4']=$arreglo;
                header("location: 15 SistemaVonline-liboCar.php");
            }
            else{
                $nombre="";
                $precio="";
...
<body>
    ...
    <?php 
    $total = 0;
    if ($_SESSION['carrito4']){
        $arregloCar = $_SESSION['carrito4'];
   ...
   <?php 
    ...
    <div class="colum-dere">
        <button class="btn-re" onclick="window.location = '15 SistemaVonlineCompra-lib.php'">Realizar compra</button>
    </div>
    </div>
