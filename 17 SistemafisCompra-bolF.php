<?php
    ...
    if (!isset($_SESSION['carrito9'])){
        header('location: 17 Sistemafis-Bol.php');
    }
...
<body>
   ...
   <div class= "dos-colum2"> 
    ...
    <center><button class="btn-re" onclick="window.location = '17 Sistemafis-Bol.php'">Regresar a la tienda</button></center>
